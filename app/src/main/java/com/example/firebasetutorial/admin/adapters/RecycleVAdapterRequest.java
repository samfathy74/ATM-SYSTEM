...
public class RecycleVAdapterRequest extends FirebaseRecyclerAdapter<Notification, RecycleVAdapterRequest.DataHolderView> {
    Context context;
    ...
    public RecycleVAdapterRequest(@NonNull FirebaseRecyclerOptions<Notification> options) {
        super(options);
    }
