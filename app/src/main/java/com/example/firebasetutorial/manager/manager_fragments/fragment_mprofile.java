...
public class fragment_mprofile extends Fragment {
    ...
    private void DefinationVariables(View view) {
    ...
    //method specific to profile image
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST_CODE && resultCode == RESULT_OK) {
            try {
                ...
                Toast.makeText(getActivity(), "Succeed upload image to Local mobile\n" + resultCode + " , " + requestCode, Toast.LENGTH_LONG).show();
    ...
    private void UploadToFirebase(Uri imageUri) {
        ...
        SReference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(getActivity(), "Succeed upload image\n" + taskSnapshot.getStorage().getRoot() + taskSnapshot.getStorage().getPath(), Toast.LENGTH_SHORT).show();
    ...
    private void getUserData(){
        SharedPreferences prefs = getActivity().getSharedPreferences("mprofileData", MODE_PRIVATE);
    ...
    private void updateUsersData(String key, String value) {
        ...
        preferences = getActivity().getSharedPreferences("mprofileData", MODE_PRIVATE);
        ...
        auth.updateCurrentUser(auth.getCurrentUser()).addOnCompleteListener(getActivity(), new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    try {
                        db.getReference().child("User").child("Manager").child(uid).child(key).setValue(value);
